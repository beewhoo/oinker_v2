namespace :res do
  ...
  #
  # API_CLIENT_ID=ENV['CLIENT_ID']
  #
  # puts "= Getting the EVENTS"
  #
  # url = "https://api.seatgeek.com/2/events?listing_count.gt=0&highest_price.lte=100&venue.city=toronto&per_page=25&client_id=#{API_CLIENT_ID}"
  #
  #
